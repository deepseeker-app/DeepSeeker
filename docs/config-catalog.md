...
- `@deepseek-ai/dsh-client-ui-deepseek-balance` — requires `webServer` · `credentials` ([`packages/client/ui-deepseek-balance/src/index.ts`](../packages/client/ui-deepseek-balance/src/index.ts))
