...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  sharedEventSource: 'client-side cross-tab SSE ownership service — packages/client/hmr/README.md owns the API',
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'remote-web-ui/authorize-http': 'host-private paired HTTP authorization — packages/client/connection/README.md owns the API',
  'remote-web-ui/authorization-changed': 'host-private authorization revocation signal — packages/client/connection/README.md owns the API',
